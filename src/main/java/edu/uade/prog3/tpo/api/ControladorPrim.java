...
public class ControladorPrim {
     ...
     *
     * Ejemplos:
     *  - /api/grafos/prim?inicioId=DEP_SUR&criterio=DISTANCIA
     *  - /api/grafos/prim?inicioId=DEP_SUR&criterio=DISTANCIA&ids=DEP_SUR,SUC_FLORES,SUC_PARQUEPATRICIOS,DEP_NORTE,SUC_PALERMO,SUC_BELGRANO,SUC_CABALLITO
     *
